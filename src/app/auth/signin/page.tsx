  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-bold text-[#f5f5f5] mb-2">Welcome to HostBook</h1>
        <p className="text-[#525252] text-sm mb-8">
          STR bookkeeping that stays in your Google Drive.
        </p>
        ...
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-6">
          ...
          <p className="text-xs text-[#525252] mt-4">
            A Google Sheet will be created in your Drive to store your data.
